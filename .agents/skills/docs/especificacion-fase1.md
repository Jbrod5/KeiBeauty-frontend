...
3. **Carrito de Compras:** Detalle de ítems seleccionados, desglose de Subtotal, Costo de Envío (Q30.00) y Total, con botón directo a finalizar pago (esto es solo ejemplo).
