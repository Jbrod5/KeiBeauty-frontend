...
5. Documentar en el README.md lo relacionado a llamadas a endpoints, json que se envia, desde donde o json que se requiere.
6. La documentacion interna con comentarios debe hacerse en español.
7. Priorizar estilos con bootstrap.
